...
// CORS configuration
app.use(cors({
  origin: ['https://locexcoinp2pauction.com','https://locexcoinp2pauction.vercel.app','http://localhost:5173'],
  credentials: true,
...
// End auctions
cron.schedule('50 6 * * 1-6', endAuctionSession); // End morning auction at 10:00 AM
